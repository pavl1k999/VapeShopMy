...
const i18n = {
  ru: {
    ...
    aboutBtn: "О нас",    
    aboutTitle: "О нас",
    aboutCities: "Работаем в <b>Košice</b> и <b>Prešov</b>",
    aboutPickup: "Самовывоз: <b>Pražska 2</b>, <b>Aupark</b>, <b>TUKE</b>",
    aboutPayment: "Любые способы оплаты — наличные, карты, переводы",
    aboutNote: "Telegram может блокировать каналы — используйте наш переходник",
  ...
  ua: {
    ...
    aboutBtn: "Про нас",
    aboutTitle: "Про нас",
    aboutCities: "Працюємо в <b>Košice</b> та <b>Prešov</b>",
    aboutPickup: "Самовивіз: <b>Pražska 2</b>, <b>Aupark</b>, <b>TUKE</b>",
    aboutPayment: "Будь-які способи оплати — готівка, карти, перекази",
    aboutNote: "Telegram може блокувати канали — використовуйте перехідник",
  ...
  en: {
    ...
    aboutBtn: "About us",
    aboutTitle: "About us",
    aboutCities: "We operate in <b>Košice</b> and <b>Prešov</b>",
    aboutPickup: "Pickup: <b>Pražska 2</b>, <b>Aupark</b>, <b>TUKE</b>",
    aboutPayment: "All payment methods — cash, cards, transfers",
    aboutNote: "Telegram may block channels — use our redirect link",
